...
$resizedImage.Save("logo_header_200x80.png", [System.Drawing.Imaging.ImageFormat]::Png)
...
Write-Host "Logo resized successfully to logo_header_200x80.png (200x80 pixels)" 