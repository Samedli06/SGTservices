...
$originalImage = [System.Drawing.Image]::FromFile("logo_header_original.png")

# Create a new bitmap with 200x80 pixels size
$newWidth = 200
$newHeight = 80
...
$resizedImage.Save("logo_header_normal.png", [System.Drawing.Imaging.ImageFormat]::Png)
...
Write-Host "Logo resized successfully to logo_header_normal.png (200x80 pixels)" 